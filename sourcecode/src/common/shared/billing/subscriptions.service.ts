...
export class Subscriptions {
    ...
    /**
     * Create a new subscription on Authorize.net.
     */
    public createOnAnet(params: {plan_id: number, start_date?: string}): Observable<{user: User}> {
        return this.http.post('billing/subscriptions/anet', params);
    }
